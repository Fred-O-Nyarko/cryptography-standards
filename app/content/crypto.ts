...
export const slideScaffold = [
  {
    id: "title",
    title: "Cryptography Techniques: Interactive Learning Journey",
    kicker: "Cybersecurity class project",
    points: [
      "A phased learning app for DES, 3DES, AES, RSA, ElGamal, and ECC.",
      "Phase 1 proves the experience model before algorithm-specific internals are added.",
    ],
  },
  {
    id: "journey",
    title: "Learning Journey",
    kicker: "How students move through each topic",
    points: [
      "Concept first: what the algorithm is trying to achieve.",
      "Math second: the minimum formal model needed to reason rigorously.",
      "Process third: key generation, encryption, decryption, and security context.",
    ],
  },
  {
    id: "map",
    title: "Algorithm Map",
    kicker: "Two families, six modules",
    points: [
      "Symmetric: DES, 3DES, AES use shared secret keys and block-cipher thinking.",
      "Asymmetric: RSA, ElGamal, ECC use public/private key pairs and hard math problems.",
    ],
  },
  {
    id: "comparison",
    ...
    points: [
      "Symmetric cryptography is efficient and depends on shared-key handling.",
      "Asymmetric cryptography solves different key distribution problems but is mathematically heavier.",
    ],
  },
  {
    id: "demo",
    title: "Interactive Demo Placeholder",
    kicker: "Why Phase 1 includes a toy visualizer",
    points: [
      "The toy block visualizer validates step controls, bit grids, reduced motion, and explanation panels.",
      "Future phases replace the toy data with real algorithm-specific demonstrations.",
    ],
  },
  {
    id: "references",
    title: "Reference Backbone",
    kicker: "Credibility for class delivery",
    points: [
      "Standards and primary papers are tracked inside the app from the start.",
      "Each future algorithm lesson will cite its source material at the section level.",
    ],
  },
];
